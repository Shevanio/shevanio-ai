...
const reviewGateFreshReviewContinuation = "run the fresh full review of the current state with shevanio-ai review start"
...
const reviewGateAmbiguousGovernanceReason = "multiple terminal native review receipts govern the current repository state; " +
	"bind the governing one to the change with shevanio-ai review bind-sdd"
