...
Shevanio AI writes to the global steering file (`~/.kiro/steering/shevanio-ai.md`) — treat it as your active working context alongside your project steering files.
