...
// Steering content is written to ~/.kiro/steering/shevanio-ai.md via StrategySteeringFile.
...
func (a *Adapter) SystemPromptFile(homeDir string) string {
	return filepath.Join(a.SystemPromptDir(homeDir), "shevanio-ai.md")
}
...
func (a *Adapter) SettingsPath(homeDir string) string {
	// Kiro's OS app settings remain a secondary Shevanio AI path; CodeGraph MCP
