...
`)
	...
	want := strings.Join([]string{
		"github.com/shevanio/shevanio-ai/v2,example.com/private",
		"github.com/shevanio/shevanio-ai/v2,github.com/acme/*",
		"github.com/shevanio/shevanio-ai/v2",
	}, "\n")
	if got != want {
...
func TestWindowsInstallScriptBetaGoInstallPreservesGoProxyBypassEnv(t *testing.T) {
	...
	for _, clobber := range []string{
		"$env:GONOSUMDB = \"github.com/shevanio/shevanio-ai/v2\"",
		"$env:GOPRIVATE = \"github.com/shevanio/shevanio-ai/v2\"",
		"$env:GONOPROXY = \"github.com/shevanio/shevanio-ai/v2\"",
	} {
		if strings.Contains(script, clobber) {
