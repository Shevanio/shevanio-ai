...
const (
	TargetedValidationRequestSchema   = "shevanio-ai.review-targeted-validation-request/v1"
	TargetedValidationRequestSchemaID = "https://shevanio-ai.dev/contracts/review-integration/v1/schemas/targeted-validation-request.schema.json"
)
...
func targetedValidationRequestHash(request TargetedValidationRequest) string {
	...
	sum := sha256.Sum256(append([]byte("shevanio-ai.review-targeted-validation-request/v1\x00"), payload...))
