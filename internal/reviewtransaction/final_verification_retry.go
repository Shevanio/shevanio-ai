...
const (
	FinalVerificationIncidentSchema                   = "shevanio-ai.review-final-verification-incident/v1"
	FinalVerificationIncidentProceduralToolingFailure = "procedural_tooling_failure"
	CompactFinalVerificationRetryProofSchema          = "shevanio-ai.review-final-verification-retry-proof/v1"
	FinalVerificationRetryAuthorizationSchema         = "shevanio-ai.review-final-verification-retry-authorization/v1"
...
func resolveFinalVerificationRetryStores(ctx context.Context, repo, predecessorLineage, successorLineage string) (CompactStore, CompactStore, string, error) {
	...
	authorityRoot, err := canonicalLocatorDirectory(filepath.Join(identity.GitCommonDir, "shevanio-ai", "review-transactions"))
