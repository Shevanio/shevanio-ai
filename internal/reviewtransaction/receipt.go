...
const ReceiptSchema = "shevanio-ai.review-receipt/v1"
...
func ParseReceipt(payload []byte) (Receipt, error) {
	payload, _ = normalizeLegacyProductIdentity(payload)
...
type GateScopeChangeDiagnostics struct {
	...
	// shevanio-ai.review-integration/v1 failure envelope, whose published
