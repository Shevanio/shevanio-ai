...
func classifiedAuthorityRepairAssessmentDigest(assessment AuthorityRepairAssessment) (string, error) {
	return classifiedAuthorityRepairDigest("shevanio-ai.review-classified-assessment-digest/v1", assessment)
}
...
func classifiedAuthorityRepairRequestDigest(request ClassifiedAuthorityRepairRequest) (string, error) {
	...
	return classifiedAuthorityRepairDigest("shevanio-ai.review-classified-request-digest/v1", canonical)
}
...
func classifiedAuthorityRepairRecordIdentity(record CompactReclaimRecord) (string, error) {
	...
	return classifiedAuthorityRepairDigest("shevanio-ai.review-classified-record-identity/v1", canonical)
}
