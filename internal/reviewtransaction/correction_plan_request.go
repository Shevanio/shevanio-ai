...
const (
	CorrectionPlanRequestSchema   = "shevanio-ai.review-correction-plan-request/v1"
	CorrectionPlanRequestSchemaID = "https://shevanio-ai.dev/contracts/review-integration/v1/schemas/correction-plan-request.schema.json"
)
