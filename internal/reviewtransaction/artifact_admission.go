...
const ArtifactAdmissionSchema = "shevanio-ai.review-artifact-admission/v1"
...
const artifactRecaptureContinuation = "the rejected admission did not consume the lens slot, " +
	"so re-run the lens and invoke shevanio-ai review capture-result again on the same lineage " +
