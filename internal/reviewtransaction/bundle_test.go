...
func correctedBundleFixture(t *testing.T, repo, lineage string) correctedBundleTestFixture {
	...
	for path, content := range map[string]string{
		...
		ledgerPath:   "{\"schema\":\"shevanio-ai.review-ledger/v1\",\"findings\":[{\"id\":\"BRT1-005\",\"lens\":\"resilience\",\"location\":\"internal/reviewtransaction/bundle.go\",\"severity\":\"CRITICAL\",\"claim\":\"corrected lineages cannot recover authority\",\"proof_refs\":[\"bundle.go:209\"]}]}",
