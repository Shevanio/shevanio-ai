...
// new lineage under <git-common-dir>/shevanio-ai/review-transactions/v3/<lineage>/:
...
const NewLineageAuthoritySchema = "shevanio-ai.review-authority/v3"

// NewLineageReceiptSchema identifies the v3 immutable terminal receipt shape.
const NewLineageReceiptSchema = "shevanio-ai.review-receipt/v3"
...
const newLineageReplayDomain = "shevanio-ai.review-replay/v3"
