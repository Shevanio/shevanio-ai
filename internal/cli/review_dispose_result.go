...
func RunReviewDisposeResult(args []string, stdout io.Writer) error {
	...
	authorization := flags.String("maintainer-authorization", "", "exact eleven-line LF-only binding: shevanio-ai.review-result-disposition-authorization/v1, repository, lineage, revision, target_identity, lens, order, artifact_digest, class, actor, reason")
