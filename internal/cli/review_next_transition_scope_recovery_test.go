...
// again. The shevanio-ai.review-recovery-authorization/v1 collection was
...
func TestNegotiatedStatusRoutesApprovedScopeChangeToBoundRecovery(t *testing.T) {
	...
	if input.Schema != "shevanio-ai.review-recovery-authorization/v1" || input.CaptureOperation != "external.authorize_recovery" {
