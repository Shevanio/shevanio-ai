...
const (
	inspectAuthorityTestSchema    = "shevanio-ai.review-authority-inspection/v1"
...
func TestReviewInspectAuthorityHelpAndArguments(t *testing.T) {
	t.Run("help", func(t *testing.T) {
		...
		if !strings.Contains(output.String(), "Usage: shevanio-ai review inspect-authority [flags]") ||
...
func writeInspectCLIRecoveryPair(t *testing.T, repo, prefix string, unchanged bool, authorization string) {
	...
	if authorization == "" {
		successor.Recovery.MaintainerAuthorization = "shevanio-ai.review-recovery-authorization/v1\npredecessor_lineage=" + predecessor.LineageID +
