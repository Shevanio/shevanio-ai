...
// product says how to produce a valid one. `shevanio-ai review schema reviewer`
...
func TestReviewCaptureResultPointsAtTheSchemaThatProducesItsInput(t *testing.T) {
	const pointer = "shevanio-ai review schema reviewer"
...
// points at `shevanio-ai review schema reviewer`: the verb rejects --help, and
