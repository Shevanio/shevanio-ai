...
func printHelp(w io.Writer, version string) {
	fmt.Fprintf(w, `shevanio-ai — Shevanio AI: Ecosystem, Frameworks, Workflows (%s)

USAGE
  shevanio-ai                     Launch interactive TUI
  shevanio-ai <command> [flags]

COMMANDS
  install      Configure AI coding agents on this machine
  uninstall    Remove Shevanio AI managed files from this machine
  ...
  review mode <enable|disable|status> [--cwd <repo>] [--scope <global|clone>]
               ...
               'shevanio-ai review mode disable', and a session without a terminal reviews
...
Run 'shevanio-ai help' for this message.
Documentation: https://github.com/Shevanio/shevanio-ai
`, version)
}
