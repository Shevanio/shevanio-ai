...
type Manifest struct {
	...
	// CreatedByVersion is the shevanio-ai version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".shevanio-ai", "backups"), nil
}
...
// of the expected backup root (~/.shevanio-ai/backups/). This prevents a tampered
