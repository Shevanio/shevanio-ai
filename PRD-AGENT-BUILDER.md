...
```
~/.config/shevanio-ai/custom-agents.json
```
...
sequenceDiagram
    participant User
    participant TUI as Shevanio AI TUI
...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        REGISTRY_FILE["~/.config/shevanio-ai/custom-agents.json"]
...
| R-AB-08 | The Agent Builder MUST maintain a local registry of custom agents at `~/.config/shevanio-ai/custom-agents.json` | P0 |
