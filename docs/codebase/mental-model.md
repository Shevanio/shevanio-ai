...
Shevanio AI is an ecosystem configurator for AI coding agents. It owns the installer, sync flows, adapters, and managed asset injection; it does not own the runtime behavior of external agents or Engram internals.
...
| A generic package manager | Dependency hints and installs support Shevanio AI components only. |
