...
|---|---|---|
| `cmd/shevanio-ai/` | Binary entrypoint and version handoff. | Business rules or file mutation logic. |
...
| `internal/state/` | `~/.shevanio-ai/state.json` persisted install selections. | Engram memory state. |
