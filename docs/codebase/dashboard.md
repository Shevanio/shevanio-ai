...
Shevanio AI does not currently contain dashboard source code. This page exists to prevent accidental invention of dashboard, HTMX, auth, or admin behavior while documenting the codebase.
...
- **No direct local DB assumptions**: do not read `.engram/engram.db` from Shevanio AI dashboard code unless the architecture explicitly chooses that boundary.
