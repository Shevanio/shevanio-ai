...
Codex, Claude Code, and OpenCode installs wire this command into startup/plugin hooks. Pi gets equivalent behavior from its currently installed compatibility package; keep those hook/plugin scan roots in sync when changing these discovery rules.
