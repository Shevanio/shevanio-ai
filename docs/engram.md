...
For the complete source, configuration options, and contribution guide, use the canonical repository: [github.com/Shevanio/shevanio-engram](https://github.com/Shevanio/shevanio-engram)
