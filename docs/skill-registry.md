...
Audits each indexed SKILL.md against docs/skill-style-guide.md
   ...
   │
   ▼
Run shevanio-ai skill-registry refresh again
```
...
```bash
shevanio-ai skill-registry list          # name<TAB>scope<TAB>path
shevanio-ai skill-registry list --json   # machine-readable, includes descriptions
```
