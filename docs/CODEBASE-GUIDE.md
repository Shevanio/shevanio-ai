# Shevanio AI Codebase Guide

This guide helps maintainers find the right code path before changing Shevanio AI. It is an index, not a full API reference.
...
| [Sync and cloud](codebase/sync-and-cloud.md) | Separate Shevanio AI config sync from Engram memory/cloud sync. |
