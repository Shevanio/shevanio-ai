...
| Evidence | Result |
|---|---|
| Focused | `env -u SHEVANIO_AI_CHANNEL PATH=/home/linuxbrew/.linuxbrew/bin:/usr/local/bin:/usr/bin:/bin go test -count=1 ./internal/reviewtransaction ./internal/cli ./internal/components/sdd` — passed. |
| Full | `env -u SHEVANIO_AI_CHANNEL PATH=/home/linuxbrew/.linuxbrew/bin:/usr/local/bin:/usr/bin:/bin go test ./...` — passed. |
| Vet | `env -u SHEVANIO_AI_CHANNEL PATH=/home/linuxbrew/.linuxbrew/bin:/usr/local/bin:/usr/bin:/bin go vet ./...` — passed. |
