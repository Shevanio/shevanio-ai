...
Keep Shevanio AI an ecosystem configurator: agents implement organically; RDD begins after a candidate exists. Remove the unreleased control plane without losing invariants, contributions, or safe shutdown.
