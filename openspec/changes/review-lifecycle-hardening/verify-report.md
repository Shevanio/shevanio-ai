...
- Typed refusals naming concrete commands verbatim: 1812 names `shevanio-ai review start --projection staged` and `shevanio-ai review start --base-ref <ref> --committed-only` (`review_facade.go:975-977`); 1788 names `shevanio-ai review capture-evidence` then `shevanio-ai review finalize --lineage <id> --captured-evidence` with the real lineage interpolated (`:1834-1839`).
