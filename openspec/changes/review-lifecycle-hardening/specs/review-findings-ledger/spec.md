...
- GIVEN `shevanio-ai review-start` receives an intended-untracked manifest
...
- GIVEN `shevanio-ai review schema` is invoked
- WHEN the input schema catalog is emitted
- THEN it includes the `shevanio-ai.review-verification-evidence/v1` payload contract
