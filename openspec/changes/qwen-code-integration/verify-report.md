...
- S-01: Consider adding integration test for the full `shevanio-ai install --agent qwen-code --dry-run` flow in a test harness (currently only verified manually).
