...
```json
{
  ...
  "rollbackBoundary": "Revert internal/cli/run.go, internal/components/communitytool/pi_codegraph.go, internal/components/communitytool/tool.go and their focused tests; this removes only Shevanio AI-owned optional Pi CodeGraph reconciliation/reporting."
}
```
