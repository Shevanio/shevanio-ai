...
Deliver an optional Pi CodeGraph capability owned by Shevanio AI. A parent `APPEND_SYSTEM.md` marker does not prove child tools, guidance, or index availability.

## Scope

### In Scope
- Own optional selection, installation, and verified Pi extension/MCP configuration in Shevanio AI.
...
### New Capabilities
- `pi-codegraph-integration`: Shevanio AI-owned optional Pi provisioning, child reconciliation, lazy initialization, verification, sync, and uninstall.
...
- [ ] Unselected Pi remains unchanged, and uninstall removes only Shevanio AI-owned integration.
