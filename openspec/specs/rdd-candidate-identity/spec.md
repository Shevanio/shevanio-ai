...
Wave 1's resolver MUST cover shevanio-ai staged, workspace, committed-range, and workspace-overlay selectors only. gentle-pi protocol-1.1 overlay selectors (absorbed backlog items pi#194, pi#197, pi#204) are out of scope for Wave 1 and are covered by the same algebra at the consumer wave.
