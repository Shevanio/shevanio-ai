...
The binding MUST reference the skill by registry name `chained-pr` (frontmatter `shevanio-ai-chained-pr`). No hardcoded path to a `SKILL.md` file is permitted as the binding reference.
